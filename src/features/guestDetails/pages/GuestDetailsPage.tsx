...
export default function GuestDetailsPage() {
  ...
  // Guest details come from route state synchronously, but the page still
  // briefly loads the guest's saved profile info (name/email/phone) to
  // prefill the form — a skeleton here avoids an instant layout pop-in.
    ...
    return (
      <PageTransition>
        ...
        <div className="flex flex-col gap-5 bg-linear-to-b from-secondary/30 to-background px-4 pb-5 pt-2">
          {Array.from({ length: roomCount || 1 }).map((_, index) => (
        ...
        <div className="fixed inset-x-0 bottom-0 mx-auto w-full max-w-[430px] border-t border-border bg-card px-4 py-4">
